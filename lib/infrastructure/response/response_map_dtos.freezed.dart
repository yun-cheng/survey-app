...
class _$_ResponseMapDto extends _ResponseMapDto {
  const _$_ResponseMapDto({required final Map<String, ResponseDto> map})
      : _map = map,
        super._();
  ...
  Map<String, dynamic> toJson() {
    return _$$_ResponseMapDtoToJson(
      this,
    );
  }
}
...
abstract class _ResponseMapDto extends ResponseMapDto {
  const factory _ResponseMapDto({required final Map<String, ResponseDto> map}) =
      _$_ResponseMapDto;
