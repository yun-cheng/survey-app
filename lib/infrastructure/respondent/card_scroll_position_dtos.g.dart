...
_$_CardScrollPositionDto _$$_CardScrollPositionDtoFromJson(
        Map<String, dynamic> json) =>
    _$_CardScrollPositionDto(
      firstCardIndex: json['firstCardIndex'] as int,
      firstCardAlignment: (json['firstCardAlignment'] as num).toDouble(),
      firstRespondent: RespondentDto.fromJson(
          json['firstRespondent'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$_CardScrollPositionDtoToJson(
