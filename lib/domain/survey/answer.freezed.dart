...
mixin _$Answer {
  ...
  AnswerBody get body;
  KtMutableMap<SerialNumber, NoteBody> get noteMap;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      noteMap: noteMap == freezed
          ? _value.noteMap
          : noteMap as KtMutableMap<SerialNumber, NoteBody>,
    ));
  }
}
...
class _$_Answer extends _Answer {
  ...
  @override
  final KtMutableMap<SerialNumber, NoteBody> noteMap;
...
abstract class _Answer extends Answer {
  ...
  const factory _Answer(
      ...
      @required SerialNumber serialNumber,
      AnswerBody body,
      KtMutableMap<SerialNumber, NoteBody> noteMap}) = _$_Answer;
