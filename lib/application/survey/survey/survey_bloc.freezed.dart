...
class _$_WatchSurveyMapStarted implements _WatchSurveyMapStarted {
  ...
  @override
  String toString() {
    return 'SurveyEvent.watchSurveyMapStarted()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_WatchSurveyMapStarted);
  }
...
abstract class _WatchSurveyMapStarted implements SurveyEvent {
  const factory _WatchSurveyMapStarted() = _$_WatchSurveyMapStarted;
}
